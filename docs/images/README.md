...
| `05-new-netaddress-typo.png` | 8/20/2026 11:36 AM | `New-NetAddress` typo raising `CommandNotFoundException`, corrected to `New-NetIPAddress`; "Activate Windows" watermark visible | Issues 9, 10 |
